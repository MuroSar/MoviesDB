...
import com.sartimau.domain.utils.Constants.TOTAL_UPCOMING_MOVIES_BY_PAGE
import com.sartimau.domain.utils.Constants.TOTAL_UPCOMING_PAGES
...
import kotlinx.android.synthetic.main.fragment_upcoming_tab.recycler
...
class UpcomingTabFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_upcoming_tab, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getUpcomingMovies(isNetworkAvailable(this.context), page)
    }
        ...
        when (moviesData.peekContent().moviesStatus) {
            ...
            MoviesStatus.SUCCESSFUL_NEXT_PAGE -> {
                moviesData.peekContent().data?.results?.let {
                    ...
                    isLastPageLoaded = page == TOTAL_UPCOMING_PAGES
                }
            }
    ...
    private fun getPaginationScrollListener(context: Context?, linearLayoutManager: LinearLayoutManager): PaginationScrollListener {
        return object : PaginationScrollListener(linearLayoutManager) {
            ...
            override val totalPageCount: Int
                get() = TOTAL_UPCOMING_MOVIES_BY_PAGE
            ...
            override fun loadMoreItems() {
                ...
                viewModel.getUpcomingMoviesNextPage(isNetworkAvailable(context), page)
            }
        }
    }

    companion object {
        const val TITLE = "Upcoming"
    }
}
